...
public class MiniPlayer {
    ...
    public MiniPlayer(MusicBox musicBox) {
        ...
        // SONGS BUTTON
        Label songsButton = new Label("Songs");
        songsButton.setStyle(
                "-fx-text-fill: #FD4CAD;" +
                "-fx-font-size: 15px;" +
                "-fx-font-weight: bold;"
        );

        songsButton.setOnMouseEntered(e -> {
            songsButton.setStyle(
                    "-fx-text-fill: #ff7bc8;" +
                    "-fx-font-size: 15px;" +
                    "-fx-font-weight: bold;"
        ...
        songsButton.setOnMouseExited(e -> {
            songsButton.setStyle(
                    "-fx-text-fill: #FD4CAD;" +
                    "-fx-font-size: 15px;" +
                    "-fx-font-weight: bold;"
        ...
        songsButton.setOnMouseClicked(e -> {
            SongScreen songScreen =
                    new SongScreen(musicBox);
            Main.appLayout.setCenter(
                    songScreen.getView()
            );
        });

        // ARTISTS BUTTON
        Label artistsButton = new Label("Artists");
        artistsButton.setStyle(
                "-fx-text-fill: #FD4CAD;" +
                "-fx-font-size: 15px;" +
                "-fx-font-weight: bold;"
        );

        artistsButton.setOnMouseEntered(e -> {
            artistsButton.setStyle(
                    "-fx-text-fill: #ff7bc8;" +
                    "-fx-font-size: 15px;" +
                    "-fx-font-weight: bold;"
        ...
        artistsButton.setOnMouseExited(e -> {
            artistsButton.setStyle(
                    "-fx-text-fill: #FD4CAD;" +
                    "-fx-font-size: 15px;" +
                    "-fx-font-weight: bold;"
        ...
        artistsButton.setOnMouseClicked(e -> {
        ...
        // PLAYLISTS BUTTON
        Label playlistsButton = new Label("Playlists");
        playlistsButton.setStyle(
                "-fx-text-fill: #FD4CAD;" +
                "-fx-font-size: 15px;" +
                "-fx-font-weight: bold;"
        );

        playlistsButton.setOnMouseEntered(e -> {
            playlistsButton.setStyle(
                    "-fx-text-fill: #ff7bc8;" +
                    "-fx-font-size: 15px;" +
                    "-fx-font-weight: bold;"
        ...
        playlistsButton.setOnMouseExited(e -> {
            playlistsButton.setStyle(
                    "-fx-text-fill: #FD4CAD;" +
                    "-fx-font-size: 15px;" +
                    "-fx-font-weight: bold;"
        ...
        playlistsButton.setOnMouseClicked(e -> {
            PlaylistScreen playlistScreen =
                    new PlaylistScreen(musicBox);
            Main.appLayout.setCenter(
                    playlistScreen.getView()
            );
        });
